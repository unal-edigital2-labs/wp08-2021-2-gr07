...
static void IR_test(void)
{
	...
	while(!(buttons_in_read()&1)){ //Cuando detecta negro es 1
...
int main(void)
{
	...
	puts("\nSoC - RiscV project UNAL 2021-2 -- CPU testing software  interrupt "__DATE__" "__TIME__"\n");
	help();
	prompt();
