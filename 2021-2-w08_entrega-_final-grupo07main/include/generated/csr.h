...
/* ultraSound_cntrl */
#define CSR_ULTRASOUND_CNTRL_BASE (CSR_BASE + 0x3800L)
#define CSR_ULTRASOUND_CNTRL_INIT_ADDR (CSR_BASE + 0x3800L)
...
#define CSR_ULTRASOUND_CNTRL_DISTANCE_ADDR (CSR_BASE + 0x3804L)
...
#define CSR_ULTRASOUND_CNTRL_DONE_ADDR (CSR_BASE + 0x3808L)
...
/* DHT11_cntrl */
#define CSR_DHT11_CNTRL_BASE (CSR_BASE + 0x4000L)
#define CSR_DHT11_CNTRL_INIT_ADDR (CSR_BASE + 0x4000L)
#define CSR_DHT11_CNTRL_INIT_SIZE 1
static inline uint32_t DHT11_cntrl_init_read(void) {
	return csr_read_simple(CSR_BASE + 0x4000L);
}
static inline void DHT11_cntrl_init_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x4000L);
}
#define CSR_DHT11_CNTRL_TEMP_ADDR (CSR_BASE + 0x4004L)
#define CSR_DHT11_CNTRL_TEMP_SIZE 1
static inline uint32_t DHT11_cntrl_temp_read(void) {
	return csr_read_simple(CSR_BASE + 0x4004L);
}
#define CSR_DHT11_CNTRL_DONE_ADDR (CSR_BASE + 0x4008L)
#define CSR_DHT11_CNTRL_DONE_SIZE 1
static inline uint32_t DHT11_cntrl_done_read(void) {
...
/* uart1 */
#define CSR_UART1_BASE (CSR_BASE + 0x6800L)
#define CSR_UART1_RXTX_ADDR (CSR_BASE + 0x6800L)
...
#define CSR_UART1_EV_PENDING_ADDR (CSR_BASE + 0x6810L)
...
#define CSR_UART1_EV_ENABLE_ADDR (CSR_BASE + 0x6814L)
